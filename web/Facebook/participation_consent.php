				...
				<div class="content">
					<div class="info">
						<form name="participant_info" method="post" action="check_participation_consent.php">
							<h1><?php echo $survey_title; ?> - Participation Consent Form</h1>
							...
							contact us by e-mail. If you have any questions prior to beginning the study then you should also contact 
							us by e-mail.</p>
